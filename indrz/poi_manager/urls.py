...
from poi_manager.views import poi_category_list, add_category, poi_category_json, poi_by_name, poi_list,\
    poi_category_by_name, get_poi_by_cat_name, get_poi_by_id, get_poi_by_cat_id, get_poicat_by_id
...
urlpatterns = [
               ...
               # url(r'^name/(?P<cat_id>\d{1,6})/$', get_poi_by_cat_id, name='get pois by category id'),
